# BITSTASH Address
Represents a BITSTASH address. Addresses are the most popular way to make BITSTASH transactions.

## Instantiate an Address
To be able to receive BITSTASHs an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
